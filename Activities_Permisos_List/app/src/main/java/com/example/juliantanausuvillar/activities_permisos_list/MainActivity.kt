...
class MainActivity : AppCompatActivity() {
    ...
    fun showToast(){
        Toast.makeText(this,"Hello from te Toast",Toast.LENGTH_LONG).show()
    }

    fun showSnackBar(){
        val layout = findViewById<ConstraintLayout>(R.id.constraint)

        //barra inferior k luego se esconde
        //Snackbar.make(layout, "Hello from te Toast", Snackbar.LENGTH_LONG).show()

        Snackbar.make(layout, "Hello from te Toast", Snackbar.LENGTH_LONG).setAction("UNDO"){
