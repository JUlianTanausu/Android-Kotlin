...
class Classes {
    ...
    private fun showCase1(){
        // Clases en Kotlin pueen tener un constructor PRIMARIO y uno o más constructores SECUNDARIOS
        // PRIMARIO se encuentra en la firma de la declaración de la clase
        // SECUNDARIO se encuentra dentro de la decalracion de la clase

        // CONSTRUCTORES PRIMARIOS
        class Person1
        class Person2 constructor(var firstname: String)// constructor primario
        class Person3 (var fistName: String) // "constructor" puede ser omitido
        class Person4 (val fistName: String, val lastName: String, var age: Int){
            init {
                age = 10
            }
        }
        ...
        // para crear instancias de objenots, no usamos "new"
        val p1 = Person1()
        val p2 = Person2("Alejandro")
        val p3 = Person3("Alejandro")
        val p4 = Person4("Alejandro", "Lora", 27)
        val p5_1 = Person5("Roberto") // los demas por defecto en la class
        val p5_2 = Person5(age = 30)
    ...
    private fun showCase3(){
        ...
        class Person1{
            // Init va a ejecutar antes que el constructor secundario y despues que el constructor primario
            init {
                Log.w("CLASSSES-3", "Welcome from INIT!")// ON puedes acceder a firstName o lastName
            }

            constructor(firstName: String, lastName: String){
                Log.w("CLASSSES-3", "Welcome from SECONDARY CONSTRUCTOR!")
            }
        ...
        class Person2(firstName: String, lastName: String){
            init{
                // aqui si podemos acceder a las propiedades, conservado init y constructor secundario
            }
    ...
    private fun showCase4(){
        ...
        class Person2(var firstName: String) // puedes acceder a firstName cuanodo crees la instancia. Puedes cambiar su valor
    ...
    private fun showCase5(){
        ...
        p1.firstName = "Antonio" // Seía el equivalente a setFirstName("Antonio")

        class Person2 {
            // field - representa a la propiedad, nunda usar this.propiedad
    ...
    private fun showCase6(){
        ...
        // Si heredamos de Person1, las propiedades no se pueden llamar de igaul forma entre padre e hijo
    ...
    private fun showCase8(){
        ...
        val p2 = p
        val personString = p.toString()   // gracias a que es data class
        val personCopy = p.copy() // crea un clon del objeto
        ...
        Log.w("CLASSES-8", "p must have some property values than personCopy => ${p == personCopy}") // True, Structural Equality
        ...
        Log.w("CLASSES-8", "firstName by Destructuring must be 'Lora' => ${lastName}")
    ...
    private fun showCase9(){
        ...
        Log.w("CLASSES-9","ENUM DayOfWeek.MONDAY should be FRIDAY => ${DayOfWeek.FRIDAY.name}")
        Log.w("CLASSES-9","ENUM DayOfWeek.MONDAY should be 4 => ${DayOfWeek.FRIDAY.ordinal}")
    }
